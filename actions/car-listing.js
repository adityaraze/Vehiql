...
export async function getCars({
  ...
  try {
    ...
    // serialize and check the wishlisted status
...
export async function toggleSavedCars(carId) {
  try {
    ...
    // if car is already saved then remove it
    if (existingSave) {
      ...
      return {
        success: true,
        saved: false,
        message: "Car Removed From The Favourites",
      };
    }
    ...
    return {
      success: true,
      saved: true,
      message: "Car Added To The Favourites",
    };
  } catch (error) {
...
export async function getCarById(carId) {
  try {
    ...
    throw new Error("Error fetching car details",error);
  }
}
