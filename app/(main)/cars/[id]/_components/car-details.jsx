...
const CarDetails = ({ car, testDriveInfo }) => {
  ...
  useEffect(() => {
    if (toggleError) {
      toast.error("Failed to update the favourites");
    }
  }, [toggleError]);

  const handleSaveCar = async (e) => {
    if (!isSignedIn) {
      toast.error("Please Sign In To Save The Cars");
      router.push("/sign-in");
      return;
    }
  ...
  const formattedCurrency = formatCurrency(car.price);
  const formattedCurrencyy = formatCurrency(car.price / 60);
      ...
      <div className="flex flex-col lg:flex-row gap-8">
              ...
              {car.images.map((image, index) => {
                return (
                  ...
                  >
                    <Image
                      src={image}
                      alt={`${car.year} ${car.make} - view${index + 1}`}
                      fill
                      className="object-cover"
                    />
                  </div>
        ...
        <div>
          ...
          <Dialog>
            ...
            <DialogContent>
              <DialogHeader>
              <DialogTitle>Vehiql Car EMI Calculator</DialogTitle>
          ...
          <Card className="my-6">
            <CardContent className="p-4">
              ...
              <a href="mailto:adityamodanwal293@gmail.com">
        ...
        <div className="bg-gray-50 rounded-lg p-6">
          <div className="flex flex-col md:flex-row gap-6 justify-between">
            ...
            <div className="flex items-center gap-3">
              <LocateFixed className="h-5 w-5 text-blue-600 mt-1 flex-shirnk-0"/>
              <div>
            ...
            <div className="md:w-1/2 lg:w-1/3">
              ...
              <div>
                {testDriveInfo.dealership?.workingHours ? testDriveInfo.dealership.workingHours.sort((a,b)=>{
                  const days = [
                    "MONDAY",
                    "TUESDAY",
                    "WEDNESDAY",
